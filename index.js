...
const SonosMQTTAPI = function(discovery, settings) {
	...
	const player_related_events = ['group-mute',
		'transport-state',
		'group-volume',
		'volume-change',
		'mute-change']

	const system_related_events = ['list-change',
		'initialized',
		'topology-change']
	...
	const handleAction = function(options) {
